...
public class Diddy extends Player {
        ...
        public Diddy(float x, float y) {
                super(new SpriteSheet(ImageLoader.load("Diddy.png"), 24, 24), x, y, "STAND_RIGHT");
                gravity = .5f;
                ...
                loadSound("Resources/Batk1.wav", "attack");
                loadSound("Resources/Death.wav", "death");
        }
        ...
        public void update() {
                ...
                if (!getCurrentAnimationName().equals("DEATH_LEFT")
                                && !getCurrentAnimationName().equals("DEATH_RIGHT")) {
