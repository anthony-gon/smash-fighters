...
public class Knight extends Player {
    ...
    public Knight(float x, float y) {
        super(new SpriteSheet(ImageLoader.load("KnightBlue.png"), 24, 24), x, y, "STAND_RIGHT");
        gravity = .5f;
                ...
                return new HashMap<String, Frame[]>() {
                        {
                                put("STAND_RIGHT", new Frame[] {
                                                ...
                                                new FrameBuilder(spriteSheet.getSprite(0, 4), 7)
                                                                ...
                                                                .withBounds(8, 9, 8, 9)
                                                                .build(),
                                                new FrameBuilder(spriteSheet.getSprite(0, 5), 7)
                                                                .withScale(3)
                                                                .withBounds(8, 9, 8, 9)
                                                                .build(),
                                                new FrameBuilder(spriteSheet.getSprite(0, 6), 7)
                                                                .withScale(3)
                                                                .withBounds(8, 9, 8, 9)
                                                                .build()
                                });
                                ...
                                put("WALK_RIGHT", new Frame[] {
                                                ...
                                                new FrameBuilder(spriteSheet.getSprite(1, 5), 7)
                                                                ...
                                                                .withBounds(8, 9, 8, 9)
                                                                .build(),
                                                new FrameBuilder(spriteSheet.getSprite(1, 6), 7)
                                                                .withScale(3)
                                                                .withBounds(8, 9, 8, 9)
                                                                .build()
                                });
